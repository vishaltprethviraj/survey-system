...
export class Employee {    
    ...
    constructor(userId:string,username:string,password:string,name:string,email:string,phoneNumber:string,department:Department,designation:Designation,roleid:{_id:string; rolename:string}) {        
        this._id = userId;
